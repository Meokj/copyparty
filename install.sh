...
/usr/bin/python3 $INSTALL_DIR/copyparty-sfx.py -v "$DATA_DIR:files:rw" -a "$USERNAME:$PASSWORD" --http-only -p "$PORT" --xff-hdr x-forwarded-for --xff-src 127.0.0.1/32 --rproxy 1
EOF
